...
st.sidebar.title("Smart AI Dashboard")
...
if page == "Home":
    ...
    **Available Pipelines:**
    ...
    ⚠️ All models and outputs are pre-trained/generated by Person A. Person B handles **explainability and UI only**.
    """)
    ...
    st.info("Association Rules page will be available once 'final_association_rules.csv' is provided by your teammate.")
